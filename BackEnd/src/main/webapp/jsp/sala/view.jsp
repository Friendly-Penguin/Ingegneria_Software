...
<div id="schermo">SCHERMO</div>
        ...
        document.addEventListener('click', (event) => {
            var numeroTicket = document.getElementById("numeroTicket");
                ...
                if (target.id == 'posto') {
                    ...
                    if (target.style.backgroundColor == 'rgb(68, 68, 81)' && post_slct < (5- parseInt(numeroTicket.value))) {
                    ...
                    }else if(parseInt(numeroTicket.value) == 5){
                        alert("Nel carrello sono già presenti 5 biglietti!");

                    } else if(post_slct == (5 - parseInt(numeroTicket.value))){
    ...
    <div>
        ...
        <input type="hidden" name="controllerAction" value="CreaElementiManagement.creaBiglietti">

            <input type="hidden" name="posti" id='val' value="">
            <input type="hidden" name="proiezioneID" id="proiezioneID" value="">
            <input type="hidden" name="carrelloID" id="carrelloID1"  value="">

        </form>
        <div class="bottoneSala">
        <button type="button" id="button" onclick="inviaPosti()">Acquista</button>
        </div>
    </div>
